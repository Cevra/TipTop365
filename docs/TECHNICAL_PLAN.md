...
| E3.2 | Booking wizard steps 1–3 (property, service+addons, date/slot + recurring) rebuilt over existing `book-service` page | L | E2.2, E3.1  ✅ 2026-07-15 |
| E3.3 | Cleaner search & ranking (verified→rating→distance→price) + "first available" option | L | E1.3  ✅ 2026-07-14 |
...
| E3.6 | Broadcast matching: `booking_offers`, expiry job, **race-safe first-accept (concurrency test)** | L | E3.4  ✅ 2026-07-15 |
...
| ID | Task | Size | Depends |
|---|---|---|---|
| E7.1 | Contract templates seed (FBiH / FBiH-student / RS / Brčko / obrt-selfbill × bs/en, watermarked DRAFT) + admin editor | L | E1.5, E9.1  ✅ 2026-07-16 |
...
| E9.2 | Dashboard metrics (bookings, GMV, commission, active cleaners, conversion) | M | E5.2  ✅ 2026-07-16 |
